const SideBar = () => {
    return (
        ...
        <aside
          id="default-sidebar"
          className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-teal-400"
          aria-label="Sidebar"
        >
          <span
          ...
          <div className="h-full px-3 py-4 overflow-y-auto bg-teal-600 ">
            <ul className="space-y-2 font-medium">
              ...
              <li>
                ...
                >
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap">Online</span>
                </a>
              </li>
              <>
                <li className="flex">
                  ...
                  <a
                    href="#"
                    className="flex items-center w-50 p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >
                    username1
                  </a>
                </li>
